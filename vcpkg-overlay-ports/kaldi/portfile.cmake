vcpkg_from_github(
    ...
    PATCHES
        ...
        0002-fix-config-cmake-dependency.patch
)
...
# Use vcpkg_replace_string for atomic and safe modification (both release and debug)
foreach(_cfg IN ITEMS "lib" "debug/lib")
    set(_KALDI_TARGETS_FILE "${CURRENT_PACKAGES_DIR}/${_cfg}/cmake/kaldi/kaldi-targets.cmake")
    if(EXISTS "${_KALDI_TARGETS_FILE}")
        vcpkg_replace_string(
            "${_KALDI_TARGETS_FILE}"
            "# Generated by CMake"
            "# Generated by CMake\ninclude(CMakeFindDependencyMacro)\nfind_dependency(unofficial-openfst)"
        )
    endif()
endforeach()
